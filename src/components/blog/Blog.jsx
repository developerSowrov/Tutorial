...
import one from "../../assets/confident-business-people-standing-board-meeting.jpg";
import two from "../../assets/businessman-suit-working-tablet-with-charts-conference-room-team-brainstorm.jpg";
const Blog = () => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white rounded-lg p-4 shadow-sm">
          ...
          <p className="text-gray-700 mt-2">
            Explore the latest trends in online education, including AI-powered
            learning and personalized learning experiences.
          </p>
        </div>
        <div className="bg-white rounded-lg p-4 shadow-sm">
          <img
