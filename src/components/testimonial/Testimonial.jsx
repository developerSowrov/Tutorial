...
import one from "../../assets/portrait-young-man-with-bulb-idea-concept.jpg";
import two from "../../assets/portrait-business-woman-office.jpg";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 shadow-lg rounded-lg">
              ...
              <p className="text-gray-700 mt-4 leading-relaxed">
                Verbonix is made up of friendly and helpful people. What I most
                appreciated is their team. They are very competent and kind. In
                fact, they were ready to reply in detail to every question.
              </p>
            </div>
            ...
            <div className="bg-white p-6 shadow-lg rounded-lg">
              ...
              <p className="text-gray-500 text-sm">Regular Client</p>
              <p className="text-gray-700 mt-4 leading-relaxed">
                This company has been an integral part of our company’s success.
                They have provided outstanding solutions for both technical
                translation and corporate English courses.
              </p>
            </div>
          </div>
        </div>
